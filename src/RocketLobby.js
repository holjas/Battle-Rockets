    ...
    axios({
      ...
      const rocketHeight = res.data.map((rHeight)=> {
        ...
        if (singleRocketHeight > 100) {
          ...
          ...rHeight,orientation:orientation
        }
      })
            ...
            return (
              <div key = {index} className="flex">
                <div>
                  ...
                  name={singleRocket.rocket_id} onClick={handleRocketSelected}/>
                </div>

                <div>
                  <img className="rocket1" src={singleRocket.orientation} alt={singleRocket.rocket_name}/>
                </div>

                <div>
                  <label className="visually-hidden" htmlFor={singleRocket.rocket_id}> 
